...
static float32_t f32RandomQOutP3( void )
{
    ...
    uZ.ui =
          f32QOut[ random_ui8() % f32NumQOut ]
        | (   (   f32P2[ random_ui8() % f32NumP2 ]
                + f32P2[ random_ui8() % f32NumP2 ] )
            & 0x007FFFFF
          );
    return uZ.f;
...
static float32_t f32RandomQOutPInf( void )
{
    ...
    uZ.ui =
        f32QOut[ random_ui8() % f32NumQOut ] | ( random_ui32() & 0x007FFFFF );
    return uZ.f;
...
static float32_t f32RandomQInfP3( void )
{
    ...
    weightMaskNum = random_ui8() % f32NumQInfWeightMasks;
    uZ.ui =
          (uint_fast32_t) ( random_ui8() & 1 )<<31
        | (   ( (uint_fast32_t) ( random_ui16() & 0x1FF )<<23

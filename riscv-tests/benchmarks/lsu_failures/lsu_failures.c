//**************************************************************************
// Load/Store Unit Torture Benchmark: Failures
//--------------------------------------------------------------------------
//
...
// Try to maximize load memory ordering failures.
...
{
   // maximize load ordering failures
}
...
{
  // BENCHMARK #2:  Try to maximize load ordering failures.
